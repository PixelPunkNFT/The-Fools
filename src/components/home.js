...
import "../assets/css/styles_v5.css"
...
<div className="container-fluid">
  <div className="main-screen " >
    ...
    <div className="main-screen__content">
      ...
      <a href="https://discord.gg/7RuyDMXPR7" className="active   main-screen__subtitle" style={{color: "white"}} target="_blank"><span><span>Join our Discord</span></span></a>
    ...
    <div className="footer">
      <div className="wrap">
        <div className="wrap-inner">
          ...
          <a href="https://discord.gg/7RuyDMXPR7" className="button button--telesto" style={{borderRadius: 0}} target="noopener"><span><span>join our discord</span></span></a>
          <div className="links">
